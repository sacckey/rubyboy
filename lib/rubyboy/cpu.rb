  ...
  class Cpu
    ...
    def exec
      ...
      when 0xcb # CB prefix
        ...
        when 0x46 then bit8(0, :indirect_hl, cycles: 16)
        ...
        when 0x4e then bit8(1, :indirect_hl, cycles: 16)
        ...
        when 0x56 then bit8(2, :indirect_hl, cycles: 16)
        ...
        when 0x5e then bit8(3, :indirect_hl, cycles: 16)
        ...
        when 0x66 then bit8(4, :indirect_hl, cycles: 16)
        ...
        when 0x6e then bit8(5, :indirect_hl, cycles: 16)
        ...
        when 0x76 then bit8(6, :indirect_hl, cycles: 16)
        ...
        when 0x7e then bit8(7, :indirect_hl, cycles: 16)
